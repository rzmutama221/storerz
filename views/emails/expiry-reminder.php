<?php
/**
 * Email Template: Expiry Reminder (H-3)
 * Sent by cron job 3 days before product expires.
 * 
 * Variables:
 * - $username: string
 * - $product_name: string
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#2c2c2c; border-radius:12px; border:1px solid #3a3a3a; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h2 style="margin:0 0 16px; font-size:20px; font-weight:600; color:#f59e0b;">&#9888; Masa Aktif Segera Berakhir</h2>
                            ...
                            <p style="margin:0 0 24px; font-size:14px; line-height:1.6; color:#a0a0a0;">
                                Masa aktif produk Anda akan segera berakhir. Segera perpanjang agar layanan tidak terputus.
                            </p>

                            <!-- Product Info Box -->
                            <div style="padding:16px; background-color:#171717; border-radius:8px; border:1px solid #f59e0b; margin-bottom:24px;">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding:4px 0; font-size:12px; color:#a0a0a0;">Produk</td>
                                        <td style="padding:4px 0; font-size:12px; color:#ffffff; text-align:right; font-weight:600;"><?= htmlspecialchars($product_name) ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding:4px 0; font-size:12px; color:#a0a0a0;">Berakhir</td>
                                        <td style="padding:4px 0; font-size:12px; color:#f59e0b; text-align:right; font-weight:600;"><?= htmlspecialchars($expired_date) ?></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <p style="margin:0; font-size:12px; color:#a0a0a0; text-align:center;">
                                Anda bisa memesan ulang produk yang sama melalui menu Produk di dashboard.
                            </p>
                        </td>
                    </tr>

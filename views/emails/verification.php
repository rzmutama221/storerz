                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#2c2c2c; border-radius:12px; border:1px solid #3a3a3a; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h2 style="margin:0 0 16px; font-size:20px; font-weight:600; color:#ffffff;">Verifikasi Email Anda</h2>
                            ...
                            <p style="margin:0 0 24px; font-size:14px; line-height:1.6; color:#a0a0a0;">
                                Terima kasih telah mendaftar di RZDK Store. Klik tombol di bawah ini untuk memverifikasi alamat email Anda dan mengaktifkan akun.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding:8px 0 24px;">
                                        <a href="<?= htmlspecialchars($verify_url) ?>" style="display:inline-block; padding:14px 32px; background-color:#01a35a; color:#ffffff; font-size:14px; font-weight:600; text-decoration:none; border-radius:8px;">
                            ...
                            <div style="padding:12px 16px; background-color:#171717; border-radius:8px; border:1px solid #3a3a3a;">
                                <p style="margin:0; font-size:12px; color:#a0a0a0;">
                                    &#9432; Link ini berlaku selama <strong style="color:#ffffff;"><?= htmlspecialchars($expires_in) ?></strong>. Jika Anda tidak merasa mendaftar, abaikan email ini.
                                </p>
                            </div>
                        </td>
                    </tr>
